...
public class Dashboard {
    ...
    private static Dashboard CreateNowDashboard() {
        ...
        dashboard.Tiles.AddRange([
            ...
            ValueTile("Apparent", MetricType.Apparent, 0, 2, displayMode: ValueTileDisplayMode.TextAndValue, showUnit: true, showIcon: true, showTopValueGradient: true, decimalPlaces: 1, iconColorSchemeName: "", colorSchemeName: "Temperature", textColorSchemeName: "Temperature", valueSchemeName: "Temperature", id: Guid.Parse("c4afbf1f-c81a-4a91-9524-57f730421f4c")),
            ValueTile("Humidity", MetricType.Humidity, 0, 3, displayMode: ValueTileDisplayMode.TextAndValue, showUnit: true, showIcon: true, showTopValueGradient: true, decimalPlaces: 1, iconColorSchemeName: "", colorSchemeName: "Humidity", textColorSchemeName: "Humidity", valueSchemeName: "Humidity", id: Guid.Parse("29ca29b5-bfa1-4fb8-b098-58d82f18add5")),
            ValueTile("Pressure", MetricType.Pressure, 0, 4, displayMode: ValueTileDisplayMode.TextAndValue, showUnit: true, showIcon: true, showTopValueGradient: true, decimalPlaces: 1, iconColorSchemeName: "", colorSchemeName: "Pressure", textColorSchemeName: "Pressure", valueSchemeName: "Pressure", id: Guid.Parse("82127bef-2af4-4b8e-9aeb-9047b47316ed")),
            ValueTile("Dew Point", MetricType.DewPoint, 1, 0, displayMode: ValueTileDisplayMode.TextAndValue, showUnit: true, showIcon: true, showTopValueGradient: true, decimalPlaces: 1, iconColorSchemeName: "", colorSchemeName: "", textColorSchemeName: "", valueSchemeName: "", id: Guid.Parse("0ff58579-bb06-4621-a664-e070e5ef9b0f")),
            ValueTile("Cloud Cover", MetricType.CloudCover, 1, 1, displayMode: ValueTileDisplayMode.TextAndValue, showUnit: true, showIcon: true, showTopValueGradient: true, decimalPlaces: 1, iconColorSchemeName: "", colorSchemeName: "Cloud Cover", textColorSchemeName: "Cloud Cover", valueSchemeName: "Cloud Cover", id: Guid.Parse("71123269-a775-4a6d-8a7c-7c45fa095b30")),
            ValueTile("Sky Temp", MetricType.SkyTemperature, 1, 2, displayMode: ValueTileDisplayMode.TextAndValue, showUnit: true, showIcon: true, showTopValueGradient: true, decimalPlaces: 1, iconColorSchemeName: "", colorSchemeName: "", textColorSchemeName: "", valueSchemeName: "", id: Guid.Parse("ddb58772-5602-4a6a-9e51-eb136fdb9561")),
            ValueTile("Sky Brightness", MetricType.SkyBrightness, 1, 3, displayMode: ValueTileDisplayMode.TextAndValue, showUnit: true, showIcon: true, showTopValueGradient: true, decimalPlaces: 1, iconColorSchemeName: "", colorSchemeName: "Sky Brightness", textColorSchemeName: "Sky Brightness", valueSchemeName: "Sky Brightness", id: Guid.Parse("0dc0e13f-9593-4520-b25a-7fbbaf5f9fb3")),
            ValueTile("Sky Quality", MetricType.SkyQualitySQM, 1, 4, displayMode: ValueTileDisplayMode.TextAndValue, showUnit: true, showIcon: true, showTopValueGradient: true, decimalPlaces: 1, iconColorSchemeName: "", colorSchemeName: "Sky Quality", textColorSchemeName: "Sky Quality", valueSchemeName: "Sky Quality", id: Guid.Parse("818aeb90-a085-47bb-9fb9-2b7a7cca9ac1")),
            ValueTile("Rain Rate", MetricType.RainRate, 2, 0, displayMode: ValueTileDisplayMode.TextAndValue, showUnit: true, showIcon: true, showTopValueGradient: true, decimalPlaces: 1, iconColorSchemeName: "", colorSchemeName: "Rain Rate", textColorSchemeName: "Rain Rate", valueSchemeName: "Rain Rate", id: Guid.Parse("2eee88ae-3fae-4073-a0aa-ee9ca0c6c05c")),
            ValueTile("Wind Speed", MetricType.WindSpeed, 2, 1, displayMode: ValueTileDisplayMode.TextAndValue, showUnit: true, showIcon: true, showTopValueGradient: true, decimalPlaces: 1, iconColorSchemeName: "", colorSchemeName: "Wind Speed", textColorSchemeName: "Wind Speed", valueSchemeName: "Wind Speed", id: Guid.Parse("f150fff7-c170-4904-b635-5c45eda83440")),
            ValueTile("Wind Gust", MetricType.WindGust, 2, 2, displayMode: ValueTileDisplayMode.TextAndValue, showUnit: true, showIcon: true, showTopValueGradient: true, decimalPlaces: 1, iconColorSchemeName: "", colorSchemeName: "Wind Gust", textColorSchemeName: "Wind Gust", valueSchemeName: "Wind Gust", id: Guid.Parse("5b0e0e19-23b3-43c5-8a38-3d443e7d75d7")),
            ValueTile("Wind Direction", MetricType.WindDirection, 2, 3, displayMode: ValueTileDisplayMode.TextAndValue, showUnit: true, showIcon: true, showTopValueGradient: true, decimalPlaces: 1, iconColorSchemeName: "", colorSchemeName: "", textColorSchemeName: "", valueSchemeName: "Wind Direction", id: Guid.Parse("455f430a-bf69-43bb-ba92-3545786992c3")),
            ValueTile("Star FWHM", MetricType.StarFwhm, 2, 4, displayMode: ValueTileDisplayMode.TextAndValue, showUnit: true, showIcon: true, showTopValueGradient: true, decimalPlaces: 1, iconColorSchemeName: "", colorSchemeName: "", textColorSchemeName: "", valueSchemeName: "", id: Guid.Parse("bca06f9c-1b15-41c7-b8a6-81e1c76c31a2"))
        ]);
    ...
    private static Dashboard CreateAstroDashboard() {
        ...
        dashboard.Tiles.AddRange([
            ...
            ValueTile("NELM", MetricType.SkyQualityNELM, 0, 3, displayMode: ValueTileDisplayMode.TextAndValue, showUnit: true, showIcon: true, showTopValueGradient: false, decimalPlaces: 1, colorSchemeName: "Sky Quality (NELM)", textColorSchemeName: "Sky Quality (NELM)", valueSchemeName: "Sky Quality (NELM)", id: Guid.Parse("ec0cecb6-43fa-4f9f-a98f-a82572bcc79a")),
