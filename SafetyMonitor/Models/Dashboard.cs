...
public class Dashboard {
    ...
    private static Dashboard CreateOverviewDashboard() {
        ...
        dashboard.Tiles.AddRange([
            ValueTile("Safety", MetricType.IsSafe, 0, 0, displayMode: ValueTileDisplayMode.TextOnly, showUnit: false, showIcon: true, decimalPlaces: 1, iconName: "", iconColorSchemeName: "", colorSchemeName: "Safety", textColorSchemeName: "Safety", valueSchemeName: "Safety"),
            ValueTile("Cloud Cover", MetricType.CloudCover, 0, 1, displayMode: ValueTileDisplayMode.TextAndValue, showUnit: true, showIcon: true, decimalPlaces: 1, iconName: "", iconColorSchemeName: "", colorSchemeName: "Cloud Cover", textColorSchemeName: "Cloud Cover", valueSchemeName: "Cloud Cover"),
            ValueTile("Rain Rate", MetricType.RainRate, 0, 2, displayMode: ValueTileDisplayMode.TextAndValue, showUnit: true, showIcon: true, decimalPlaces: 1, iconName: "", iconColorSchemeName: "", colorSchemeName: "Rain Rate", textColorSchemeName: "Rain Rate", valueSchemeName: "Rain Rate"),
            ValueTile("Wind Speed", MetricType.WindSpeed, 0, 3, displayMode: ValueTileDisplayMode.TextAndValue, showUnit: true, showIcon: true, decimalPlaces: 1, iconName: "", iconColorSchemeName: "", colorSchemeName: "Wind Speed", textColorSchemeName: "Wind Speed", valueSchemeName: "Wind Speed"),
    ...
    private static Dashboard CreateNowDashboard() {
        ...
        dashboard.Tiles.AddRange([
            ValueTile("Safety", MetricType.IsSafe, 0, 0, displayMode: ValueTileDisplayMode.TextOnly, showUnit: false, showIcon: true, decimalPlaces: 1, iconName: "", iconColorSchemeName: "", colorSchemeName: "Safety", textColorSchemeName: "Safety", valueSchemeName: "Safety", id: Guid.Parse("d7776357-edb5-4647-9d1c-39a2de4ea87a")),
            ValueTile("Temperature", MetricType.Temperature, 0, 1, displayMode: ValueTileDisplayMode.TextAndValue, showUnit: true, showIcon: true, decimalPlaces: 1, iconName: "", iconColorSchemeName: "", colorSchemeName: "Temperature", textColorSchemeName: "Temperature", valueSchemeName: "Temperature", id: Guid.Parse("581511d7-15fb-47c7-9ce0-fe1cfca9239b")),
            ValueTile("Humidity", MetricType.Humidity, 0, 2, displayMode: ValueTileDisplayMode.TextAndValue, showUnit: true, showIcon: true, decimalPlaces: 1, iconName: "", iconColorSchemeName: "", colorSchemeName: "Humidity", textColorSchemeName: "Humidity", valueSchemeName: "Humidity", id: Guid.Parse("29ca29b5-bfa1-4fb8-b098-58d82f18add5")),
            ValueTile("Pressure", MetricType.Pressure, 0, 3, displayMode: ValueTileDisplayMode.TextAndValue, showUnit: true, showIcon: true, decimalPlaces: 1, iconName: "", iconColorSchemeName: "", colorSchemeName: "Pressure", textColorSchemeName: "Pressure", valueSchemeName: "Pressure", id: Guid.Parse("82127bef-2af4-4b8e-9aeb-9047b47316ed")),
            ...
            ValueTile("Cloud Cover", MetricType.CloudCover, 1, 0, displayMode: ValueTileDisplayMode.TextAndValue, showUnit: true, showIcon: true, decimalPlaces: 1, iconName: "", iconColorSchemeName: "", colorSchemeName: "Cloud Cover", textColorSchemeName: "Cloud Cover", valueSchemeName: "Cloud Cover", id: Guid.Parse("71123269-a775-4a6d-8a7c-7c45fa095b30")),
            ...
            ValueTile("Sky Quality", MetricType.SkyQuality, 1, 3, displayMode: ValueTileDisplayMode.TextAndValue, showUnit: true, showIcon: true, decimalPlaces: 1, iconName: "", iconColorSchemeName: "", colorSchemeName: "Sky Quality", textColorSchemeName: "Sky Quality", valueSchemeName: "Sky Quality", id: Guid.Parse("818aeb90-a085-47bb-9fb9-2b7a7cca9ac1")),
            ValueTile("Rain Rate", MetricType.RainRate, 1, 4, displayMode: ValueTileDisplayMode.TextAndValue, showUnit: true, showIcon: true, decimalPlaces: 1, iconName: "", iconColorSchemeName: "", colorSchemeName: "Rain Rate", textColorSchemeName: "Rain Rate", valueSchemeName: "Rain Rate", id: Guid.Parse("2eee88ae-3fae-4073-a0aa-ee9ca0c6c05c")),
            ValueTile("Wind Speed", MetricType.WindSpeed, 2, 0, displayMode: ValueTileDisplayMode.TextAndValue, showUnit: true, showIcon: true, decimalPlaces: 1, iconName: "", iconColorSchemeName: "", colorSchemeName: "Wind Speed", textColorSchemeName: "Wind Speed", valueSchemeName: "Wind Speed", id: Guid.Parse("f150fff7-c170-4904-b635-5c45eda83440")),
            ValueTile("Wind Gust", MetricType.WindGust, 2, 1, displayMode: ValueTileDisplayMode.TextAndValue, showUnit: true, showIcon: true, decimalPlaces: 1, iconName: "", iconColorSchemeName: "", colorSchemeName: "Wind Gust", textColorSchemeName: "Wind Gust", valueSchemeName: "Wind Gust", id: Guid.Parse("5b0e0e19-23b3-43c5-8a38-3d443e7d75d7")),
            ValueTile("Wind Direction", MetricType.WindDirection, 2, 2, displayMode: ValueTileDisplayMode.TextAndValue, showUnit: true, showIcon: true, decimalPlaces: 1, iconName: "", iconColorSchemeName: "", colorSchemeName: "", textColorSchemeName: "", valueSchemeName: null, id: Guid.Parse("455f430a-bf69-43bb-ba92-3545786992c3")),
