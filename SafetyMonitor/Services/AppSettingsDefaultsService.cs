    ...
    public static AppSettings CreateDefaults() {
        return new AppSettings {
            ...
            MetricAxisRules = [
                ...
                new MetricAxisRuleSetting { Enabled = true, MaxBoundary = 25, MaxSpan = null, Metric = MetricType.SkyQualitySQM, MinBoundary = 5, MinSpan = 2 },
                new MetricAxisRuleSetting { Enabled = true, MaxBoundary = 8, MaxSpan = null, Metric = MetricType.SkyQualityNELM, MinBoundary = -1, MinSpan = 1 },
